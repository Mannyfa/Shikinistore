...
export default function Checkout() {
  ...
  const handleCheckoutSubmit = async (e) => {
    ...
    try {
      // POST the order to your Node.js backend
      ...
      alert("Failed to connect to the vault. Please try again.");
      setIsProcessing(false);
    }
  };
  ...
  if (orderSubmitted) {
    return (
      <div className="min-h-screen bg-luxury-white flex flex-col items-center justify-center p-4 py-24">
        <motion.div initial="hidden" animate="visible" variants={fadeUp} className="max-w-2xl w-full">
      ...
      <div className="max-w-[1400px] mx-auto px-4 md:px-8 lg:px-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24">
          ...
          <div className="lg:col-span-5">
            <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6, delay: 0.2 }} className="bg-zinc-50 p-8 md:p-10 sticky top-32 border border-zinc-200">
